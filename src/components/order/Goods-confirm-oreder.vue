  ...
  <div class="confirm-box">
    ...
    <div class="content">
      ...
      <div class="choose-address mar-t-40">
        ...
        <!-- 所有收货地址 -->
        <ul class="all-address address-box">
          <!-- 默认地址 -->
        ...
        <div>
          <div class="show-address-btn"><a @click="addAddress" v-show="show">添加地址</a></div>
      ...
      <div class="confirm-order-goods font-18 clearfix">
        ...
        <ul>
          <li class="mar-b-60">
            <div>
              ...
              <!-- 商品具体内容 -->
              <div class="confirm-order-detail mar-t-12">
        ...
        <div class="fr">
          <div class="submit-confirm text-right">
            <div class="realy-pay-title">实支付：<span class="font-32 realy-pay font-bold">￥{{goods.totalPrice}}</span></div>
            <div class="clearfix">
              <div class="fl">
...
export default {
  ...
  methods: {
    ...
    payFor () {
      ...
      let orderBillList = []
      orderBillList.push({
        sellerId: this.goods.businessId,
